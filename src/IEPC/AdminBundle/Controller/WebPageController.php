...
use IEPC\ContentBundle\Form\Type\WebPageType;
...
class WebPageController extends Controller
{
    public function indexAction()
    {
        ...
        return $this->render('IEPCAdminBundle:WebPage:index.html.twig', [
            'webpages' => $webpages
        ]);
    }
    ...
    public function editAction($id = null, Request $request)
    {
        ...
        return $this->render('@IEPCAdmin/WebPage/edit.html.twig', [
